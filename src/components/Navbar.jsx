      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm">
            <a className="text-gray-300 hover:text-white transition-colors" href="#devs">Devs</a>
            <a className="text-gray-300 hover:text-white transition-colors" href="#vote">Vote</a>
            <a className="text-gray-300 hover:text-white transition-colors" href="#store">Store</a>
